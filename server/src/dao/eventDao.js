...
module.exports = class ServerDao extends Dao {
     ...
     */
    getRidersHost(sql: string | number, callback: (status: number, data: *) => void): void {
     ...
     */
    getEventPerformances(sql: string | number, callback: (status: number, data: *) => void): void {
        super.query(`SELECT p.${CONSTANTS.PERFORMANCE_ARTIST_ID}, ${CONSTANTS.PERFORMANCE_EVENT_ID}, ${CONSTANTS.USER_PICTURE}, ${CONSTANTS.PERFORMANCE_NAME}, 
            ${CONSTANTS.USER_USERNAME},${CONSTANTS.PERFORMANCE_START_TIME}, ${CONSTANTS.PERFORMANCE_END_TIME}, ${CONSTANTS.PERFORMANCE_ID} 
