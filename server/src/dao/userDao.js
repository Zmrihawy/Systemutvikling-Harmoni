...
module.exports = class UserDao extends Dao {
    ...
    getUser(sql: number, callback: (status: number, data: *) => void) {
    ...
    getPassword(sql: string, callback: (status: number, data: *) => void) {
        super.query(`SELECT u.${CONSTANTS.USER_ID}, p.${CONSTANTS.PASSWORD_ID}, HEX(p.${CONSTANTS.PASSWORD_PASSWORD}) as ${CONSTANTS.PASSWORD_PASSWORD}, HEX(u.${CONSTANTS.USER_SALT}) as ${CONSTANTS.USER_SALT}, p.${CONSTANTS.PASSWORD_AUTOGEN} FROM ${CONSTANTS.USER_TABLE} u JOIN ${CONSTANTS.PASSWORD_TABLE} p ON 
