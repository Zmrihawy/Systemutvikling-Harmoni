...
function (_Dao) {
  ...
  _createClass(ServerDao, [{
    ...
    key: "getEventTickets",
    value: function getEventTickets(sql, callback) {
    ...
    key: "getPerformanceRiders",
    value: function getPerformanceRiders(sql, callback) {
