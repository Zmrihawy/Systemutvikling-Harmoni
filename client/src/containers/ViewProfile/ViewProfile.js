...
export default class ViewProfile extends Component {
                ...
                <div className={classes.viewProfile}>
                    <div className={classes.row}>
                        ...
                        <div className={classes.bioLayer} id={'bioLayer'}>
                            ...
                            <button
                                className={classes.redigerBrukerBtn}
                                id={'redigerBrukerBtn'}
                        ...
                        <div className={classes.editLayer} id={'editLayer'}>
                            ...
                            <input
                                type={'password'}
                                id={'passwordDeleteInp'}
                                className={classes.passwordDeleteInp}
                            ...
                            <div className={classes.row}>
                                ...
                                <button
                                    ...
                                    onClick={event => this.eventHandler()}
                                >
                                    Lagre endringene
                                </button>
                            </div>
                ...
                <div className={classes.viewProfile}>
                    <div className={classes.row}>
                        ...
                        <div className={classes.editLayer} id={'editLayer'}>
                            ...
                            <ShowPassword id={'passwordInp'} strength={true} />
                            <div className={classes.editTitle}>
                                Gjenta nytt passord
                            </div>
                            <ShowPassword
    ...
    eventHandler() {
        ...
        if (
            document.getElementById('oldPasswordInp') !== null &&
        ...
        if (
            document.getElementById('repeatPasswordInp') !== null &&
        ...
        if (!errorEvent && !emptyAll) {
            if (
                ...
                if (
                    ...
                    this.errorHandler(
                        'Nytt passord og gjentatt nytt passord må være lik.'
                    );
                    errorEvent = true;
                } else {
                    if (!this.checkUpdatePassword()) {
                        this.errorHandler(
                            'Feil med gammelt passord, prøv på nytt.'
                        );
                        errorEvent = true;
                    }
                }
    ...
    setUser() {
        ...
        if (document.getElementById('redigerBrukerBtn') !== null) {
            document.getElementById('redigerBrukerBtn').style.visibility =
                'visible';
            document.getElementById('redigerBrukerBtn').style.pointerEvents =
                'all' + '';
        }
        if (document.getElementById('passwordDeleteInp') !== null) {
            document.getElementById('passwordDeleteInp').style.visibility =
                'hidden';
            document.getElementById('passwordDeleteInp').style.pointerEvents =
                'none';
        ...
        if (
            document.getElementById('imgContainer') !== null &&
            document.getElementById('redigerBtn') !== null &&
            document.getElementById('bioLayer') !== null
        ) {
            if (window.innerWidth > 1000) {
                document.getElementById('imgContainer').style.left =
                    'calc(50% - 11vw)';
                document.getElementById('bioLayer').style.left =
                    'calc(50% - 12vw)';
                document.getElementById('redigerBtn').style.left =
                    'calc(50% - 10vw)';
            }
        }
    }
                    ...
                    if (window.confirm('Are you sure?')) {
                        ...
                        userService
                            .deleteUser(
                                ...
                                document.getElementById('passwordDeleteInp')
                                    .value
                            )
                            .then(() => {
